...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		...
		description: localize('gettingStarted.setup.description', "Customize your editor, learn the basics, and start coding 123"),
		isFeatured: true,
		icon: setupIcon,
		when: '!isWeb',
		next: 'Beginner',
...

	{
		...
		description: localize('gettingStarted.setupWeb.description', "Customize your editor, learn the basics, and start coding 123"),
		isFeatured: true,
		icon: setupIcon,
		when: 'isWeb',
		next: 'Beginner',
	...
	},
	{
		id: 'Beginner',
		isFeatured: false,
		title: localize('gettingStarted.beginner.title', "Learn the Fundamentals-123"),
		icon: beginnerIcon,
